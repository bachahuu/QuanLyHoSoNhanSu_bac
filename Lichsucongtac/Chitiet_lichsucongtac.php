...
<head>
    ...
    <section class="dashboard">
        <div class="top">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="https://png.pngtree.com/png-clipart/20210613/original/pngtree-white-silhouette-avatar-png-image_6404680.jpg" alt="Admin" class="rounded-circle" width="150">
                    <div class="mt-3">
           ...
           <div class="col-md-8">       
            <div class="col-sm-12">
                    <button class="btn btn-primary " style="margin-bottom: 10px" data-toggle="modal" data-target="#addsql">Thêm</button>
            </div>
           ...
           <?php
                ...
                <tr>
                    ...
                    <div class="col-sm-12">
                      ...
                      <a onclick="return confirm('Bạn có muốn xóa không ? ')" class="btn btn-danger "  href="Delete_lichsucongtac.php?MaLichSu=<?php echo $r['MaLichSu']; ?>">Xóa</a>
                    </div>
                    </div>
                    </td>
                </tr>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel" style="font-family: Helvetica Neue">Thêm lịch sử công tác</h1>
            </div>
            ...
            <?php
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="manhansu" class="form-control" value="<?php echo $tenNhanSu; ?>" readonly>
                </div>
                <div class="mb-3">
